          ...
          <div className="mb-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
              {videoTestimonials.map((testimonial) => (
                <div key={testimonial.id} className="relative rounded-2xl overflow-hidden shadow-lg bg-black border border-[#E2DFDE] aspect-[9/16] w-full">
                  <iframe
                  ...
                  />
                  <div className="absolute top-0 left-0 right-0 h-[22%] z-10 bg-transparent pointer-events-auto" />
                  <div className="absolute bottom-0 right-0 w-[35%] h-[12%] z-10 bg-transparent pointer-events-auto" />
                </div>
              ))}
            </div>
          </div>
